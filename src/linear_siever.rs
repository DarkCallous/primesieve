...
pub fn linear_siever_marker(base_primes: &[(usize, u8)], start_uwheel: usize, end_uwheel: usize) -> BitsetU64Wheel30{
...
pub fn linear_siever_marker_single(prime: &(usize, u8), mask: &mut BitsetU64Wheel30){
    ...
    let start_num = ((mask.start_wheel() * 30) as f64 / (prime_wheel * 30 + WHEEL[prime_id as usize]) as f64).ceil() as usize;
    let end_num = ((mask.end_wheel() * 30 + 30) as f64 / (prime_wheel * 30 + WHEEL[prime_id as usize]) as f64).ceil() as usize;
